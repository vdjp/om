...
bird_data(sparrow, brown, small, social, forests, flies, short_beak, builds_nests).
...
bird_data(peacock, large, colorful, solitary, gardens, does_not_fly, medium_beak, ground_nester).bird_data(swallow, small, blue_and_white, social, skies, flies, short_beak, builds_nests).
...
identify_bird(Bird,Size,Color,Social, Habitat, Flight, BeakShape, NestingBehavior) :-
...
start :-
    ...
    identify_bird(Size,Color, Social, Habitat, Flight, BeakShape, NestingBehavior, Bird),
    (
