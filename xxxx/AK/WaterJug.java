...
class WaterJugProblemExample {
    ...
    /*
     * create method pourWater() that accept three parameters, i.e., fromCapacity,
     * toCapacity and d
     */
    /*
     * fromCapacity is the capacity of the jug from which water is poured,
     * toCapacity is the capacity of the jug to which water is poured, and ltr is
     * the amount of water to be measured
     */
    public static int pourWater(int fromCapacity, int toCapacity, int d) {

        // declare and initialize variables which indicate the current amount of water
        ...
        // use while loop to fill d ltr amount and break it when one of the two jugs has
        // d liter amount
    ...
    // create findMisSteps() method that will returns minimum steps needed for
    // messuring d liter
    public static int findMinSteps(int i, int j, int d) {
        ...
        // We cannot solve the water jug problem when gcd of j and i is not possible to
        // divide by d
        if ((d % getGCD(j, i)) != 0)
            return -1; // we return -1 in this case
    ...
    public static void main(String[] args) {
        ...
        // initialize variables for the size of jugs and amount of water which we want
        // to measure
        int i, j, d;
